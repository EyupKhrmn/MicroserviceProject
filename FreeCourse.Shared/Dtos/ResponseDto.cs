...
namespace FreeCourse.Shared.Dtos
{
    public class ResponseDto<T>
    {
        ...
        {
            return new ResponseDto<T> { Erorrs = errors, StatusCode = statusCode, IsSuccessfull = false };
        }

        public static ResponseDto<T> Fail(string error, int statusCode)
        {
            return new ResponseDto<T> { Erorrs = new List<string>() { error }, StatusCode = statusCode, IsSuccessfull = false };
        }
        #endregion M
    }
}
